...
\begin{tikzfigure}
    \centering
    \includegraphics[scale=0.9]{images/ptnet-2.pdf}
    \captionof{figure}{%
        \small        % smaller font
...
\node [text=white,outer sep=45pt, align=center, below left] at (42,60) {\includegraphics[scale=0.55]{images/Logos/petristation-logo.pdf}};
